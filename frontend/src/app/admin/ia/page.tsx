...
// Menú "IA" del panel admin — 6 pestañas:
...
//   6. Verificación de registro → kill switch de la verificación de
//      teléfono por WhatsApp en el registro de pacientes/profesionales
...
import { RegistrationVerificationTab } from '@/components/admin/ia/RegistrationVerificationTab'
import { useLanguage } from '@/lib/i18n/LanguageContext'

type TabKey = 'bot' | 'reminders' | 'conversations' | 'broadcast' | 'automation' | 'registration_verification'
...
const TABS: { key: TabKey; label: string }[] = [
  ...
  { key: 'registration_verification', label: 'Verificación de registro' },
]
      ...
      <div className="max-w-4xl">
        <div className="mb-4">
          ...
          <p className="text-xs text-[#475569] mt-0.5">
            {t('Bot de WhatsApp, recordatorios automáticos, conversaciones, mensajería masiva, automatización de backups y verificación de registro.')}
          </p>
        </div>
        ...
        {tab === 'registration_verification' && <RegistrationVerificationTab />}
      </div>
    </DashboardLayout>
  )
}
