'use client'
// src/app/patient/help/page.tsx
// Agente de Ayuda persistente para pacientes — a diferencia de /patient/onboarding
// (que solo corre una vez, en el primer registro, para pedir alergias y
// condiciones crónicas), esta página se puede visitar en cualquier momento
// desde el botón "Ayuda" del menú para resolver dudas sobre el USO de la
// plataforma (cómo pagar, cómo agendar, cómo funciona la videoconsulta, etc.).
...
const QUICK_REPLIES_INIT = [
  ...
  '¿Qué necesito para la videoconsulta?',
]
...
export default function PatientHelpPage() {
  ...
  return (
    <DashboardLayout navItems={NAV} activeHref="/patient/help" role="PATIENT">
