'use client'
// src/components/patient/ConsultedProfessionals.tsx
//
// Contenido de la antigua página "Mis profesionales" (ahora "Profesionales
// consultados"), extraído a un componente para poder mostrarse como pestaña
// dentro de /patient/search en vez de ser una página propia con su propio
// ítem de sidebar.
//
// Agrupa todas mis consultas por profesional para encontrar rápido, por
// médico, el historial de consultas, recetas e historias clínicas que
// tengo con cada uno. No hace falta ningún endpoint nuevo: el paciente ya
// tiene acceso a TODO su historial (consultationsAPI.getMyConsultations,
// prescriptionsAPI.getMyPatient, clinicalNotesAPI.getMyHistory) — acá solo
// se agrupa por profesional en el cliente.
...
export function ConsultedProfessionals() {
  const { t } = useLanguage()
